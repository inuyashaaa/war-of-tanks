class BulletPlayer2Controller {
    constructor(position, direction, bulletName, angle) {
        ...
        this.sprite = bulletPlayer2Group.create(position.x, position.y,'bullet');
        ...
        this.sprite.body.velocity = direction.setMagnitude(BulletPlayer2Controller.BULLET_SPEED);
        bullets.push(this);
...
BulletPlayer2Controller.BULLET_SPEED = 250;
